package com.triveous.exceptions;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> cartExceptionHandler(CartException e, WebRequest re){
	...
	public ResponseEntity<ErrorDetails> categoryExceptionHandler(CategoryException e, WebRequest re){
		ErrorDetails err = new ErrorDetails(LocalDateTime.now(), e.getMessage(), re.getDescription(false));
	...
	public ResponseEntity<ErrorDetails> ordersExceptionHandler(OrdersException e, WebRequest re){
		ErrorDetails err = new ErrorDetails(LocalDateTime.now(), e.getMessage(), re.getDescription(false));
	...
	public ResponseEntity<ErrorDetails> productExceptionHandler(ProductException e, WebRequest re){
		ErrorDetails err = new ErrorDetails(LocalDateTime.now(), e.getMessage(), re.getDescription(false));
	...
	public ResponseEntity<ErrorDetails> userExceptionHandler(UserException e, WebRequest re){
		ErrorDetails err = new ErrorDetails(LocalDateTime.now(), e.getMessage(), re.getDescription(false));
